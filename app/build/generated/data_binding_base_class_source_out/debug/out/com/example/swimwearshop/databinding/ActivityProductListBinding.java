...
public final class ActivityProductListBinding implements ViewBinding {
  ...
  private ActivityProductListBinding(@NonNull ConstraintLayout rootView, @NonNull Button cartButton,
  ...
  public static ActivityProductListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProductListBinding((ConstraintLayout) rootView, cartButton, recyclerView);
    }
